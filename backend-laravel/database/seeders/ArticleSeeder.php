    ...
    public function run(): void
    {
        $articles = [
            ...
            [
                ...
                'published_date' => Carbon::parse('2024-02-10'),
                'scraped_at' => Carbon::now(),
                'is_enhanced' => false,
            ],
            [
            ...
            [
                ...
                'published_date' => Carbon::parse('2024-05-12'),
                'scraped_at' => Carbon::now(),
                'is_enhanced' => false,
            ],
            // Enhanced versions
            [
                ...
                'thumbnail' => 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&auto=format&fit=crop',
                'published_date' => Carbon::parse('2024-06-01'),
                'scraped_at' => Carbon::now(),
                'is_enhanced' => true,
            ...
            [
                ...
                'author' => 'BeyondChats AI',
                'thumbnail' => 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800&auto=format&fit=crop',
                'published_date' => Carbon::parse('2024-07-01'),
                'scraped_at' => Carbon::now(),
                'is_enhanced' => true,
